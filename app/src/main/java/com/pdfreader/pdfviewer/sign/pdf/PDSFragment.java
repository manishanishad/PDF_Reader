...
public class PDSFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        try {
            ...
            PDSPageViewer fASPageViewer = new PDSPageViewer(viewGroup.getContext(),(PdfViewActivity) getActivity(),((PdfViewActivity) getActivity()).getDocument().getPage(getArguments().getInt("pageNum")));
