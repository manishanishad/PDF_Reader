...
#ifdef DEBUG
	/* Try and send stdout/stderr to file in debug builds. getContext()
...
/* Close the document, at least enough to be able to save over it. getContext()
...
/* getContext() enum should be kept in line with SignatureState in MuPDFPageView.java */
enum
{
	Signature_NoSupport,
	Signature_Unsigned,
