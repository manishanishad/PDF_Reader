 ...
 * 时间:              下午1:48:53
 */
package com.reader.office.ss.model.XLSModel;
...
import com.reader.office.fc.xls.SSReader;
...
import com.reader.office.system.ReaderHandler;
 ...
 * <p>
 */
public class AWorkbook extends Workbook implements com.reader.office.fc.ss.usermodel.Workbook
{
    ...
    public AWorkbook(InputStream s, SSReader iAbortListener) throws IOException
    {
        ...
        List<Records> records = RecordFactory.createRecords(stream, iAbortListener);
