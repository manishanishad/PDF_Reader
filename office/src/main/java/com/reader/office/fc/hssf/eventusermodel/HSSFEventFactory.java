...
import com.reader.office.fc.hssf.record.RecordFactoryInputStream;
...
public class HSSFEventFactory {
   ...
   public short abortableProcessWorkbookEvents(HSSFRequest req, POIFSFileSystem fs)
	...
	/**
	 * Processes a DocumentInputStream into essentially Records events.
	 *
	 ...
	 *
	 * @see com.reader.office.fc.poifs.filesystem.POIFSFileSystem#createDocumentInputStream(String)
	 * @param req an Instance of HSSFRequest which has your registered listeners
	...
	private short genericProcessEvents(HSSFRequest req, InputStream in)
		...
		while(true) {
			Records r = recordStream.nextRecord();
			if(r == null) {
				break;
			}
