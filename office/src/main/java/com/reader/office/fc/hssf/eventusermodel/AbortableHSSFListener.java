 ...
 *  HSSFListener), and then override the #abortableProcessRecord(Records)
 *  method to do their processing.
 * This should then be registered with the HSSFRequest (associating
 * it with Records SID's) as usual.
 *
...
public abstract class AbortableHSSFListener implements HSSFListener
{
   ...
   /**
     ...
     */
    public abstract short abortableProcessRecord(Records record) throws HSSFUserException;
}
