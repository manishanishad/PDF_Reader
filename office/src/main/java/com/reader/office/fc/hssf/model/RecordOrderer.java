 ...
 *
 * See OOO excelfileformat.pdf sec. 4.2.5 'Records Order in a BIFF8 Workbook Stream'
 *
 * @author Josh Micich
 */
	...
	private static int findDataValidationTableInsertPos(List<RecordBase> records) {
		...
		while (i > 0) {
			...
			if (isDVTPriorRecord(rb)) {
				Records nextRec = (Records) records.get(i + 1);
