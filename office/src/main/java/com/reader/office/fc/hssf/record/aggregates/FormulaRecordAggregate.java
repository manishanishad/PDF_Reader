...
import com.reader.office.fc.hssf.util.CellRangeAddress8Bit;
 ...
 * (optional) string record and (optional) Shared Formula Records (template reads, excel optimization).
 *
...
public final class FormulaRecordAggregate extends RecordAggregate implements CellValueRecordInterface {
	...
	public void visitContainedRecords(RecordVisitor rv) {
		 ...
		 Records sharedFormulaRecord = _sharedValueManager.getRecordForFirstCell(this);
	...
	public void setCachedStringResult(String value) {
		...
		// Save the string into a String Records, creating one if required
		if(_stringRecord == null) {
