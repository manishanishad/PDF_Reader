...
/**
 * A wrapper around a DDF (Escher) EscherTextbox Records. Causes the DDF
 *  Records to be accessible as if it were a HSLF record.
...
public final class EscherTextboxWrapper extends RecordContainer
{
    ...
    /**
     * Returns the underlying DDF Escher Records
     */
    ...
    /**
     * Creates the wrapper for the given DDF Escher Records and children
     */
    public EscherTextboxWrapper(EscherTextboxRecord textbox)
    {
        ...
        _children = Records.findChildRecords(data, 0, data.length);
    }
