...
import com.reader.office.fc.util.LittleEndianByteArrayOutputStream;
 ...
 * @author Josh Micich
 */
public abstract class StandardRecord extends Records {
	 ...
	 *
	 * The subclass must write the exact number of bytes as reported by {@link com.reader.office.fc.hssf.record.Records#getRecordSize()}}
	 */
