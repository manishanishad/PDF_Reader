...
import com.reader.office.fc.hslf.model.textproperties.AutoNumberTextProp;
import com.reader.office.fc.hslf.model.textproperties.TextPropCollection;
import com.reader.office.fc.hslf.record.*;
...
public final class TextRun
{
    ...
    private void storeText(String s)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                Records[] cr = parent.getChildRecords();
    ...
    * @see com.reader.office.fc.hslf.record.TextHeaderAtom
    */
