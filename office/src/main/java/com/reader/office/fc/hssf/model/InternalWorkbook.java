...
import com.reader.office.fc.ddf.EscherBoolProperty;
...
import com.reader.office.fc.ddf.EscherRGBProperty;
...
import com.reader.office.fc.hssf.formula.EvaluationWorkbook.ExternalName;
import com.reader.office.fc.hssf.formula.EvaluationWorkbook.ExternalSheet;
import com.reader.office.fc.hssf.formula.ptg.Area3DPtg;
import com.reader.office.fc.hssf.formula.ptg.NameXPtg;
import com.reader.office.fc.hssf.formula.ptg.OperandPtg;
...
import com.reader.office.fc.hssf.util.HSSFColor;
import com.reader.office.fc.ss.usermodel.BuiltinFormats;
 ...
 * @see com.reader.office.fc.hssf.usermodel.HSSFWorkbook
 */
@ Internal
public final class InternalWorkbook
{
     ...
     * @return
     */
    public static InternalWorkbook createWorkbook(List<Records> recs)
    {
     ...
     * API.  Pass in an array of Records objects, A Workbook
     ...
     * own ;-p.
     *
     * @param recs an array of Records objects
     * @return Workbook object
     */
    public static InternalWorkbook createWorkbook(List<Records> recs, AbstractReader iAbortListener)
    {
        InternalWorkbook retval = new InternalWorkbook();
        List<Records> records = new ArrayList<Records>(recs.size() / 3);
    ...
    public static InternalWorkbook createWorkbook()
    {
        ...
        InternalWorkbook retval = new InternalWorkbook();
        List<Records> records = new ArrayList<Records>(30);
        retval.records.setRecords(records);
    ...
    /**
     * creates a new Cell-type Extneded Format Records and adds it to the end of
    ...
    public int serialize(int offset, byte[] data)
    {
        ...
        for (int k = 0; k < records.size(); k++)
        {
            ...
            //                    throw new IllegalStateException("Records size does not match serialized bytes.  Serialized size = " + len + " but getRecordSize() returns " + record.getRecordSize());
            /////  DEBUG END /////
            pos += len; // rec.length;
        }
        if (log.check(POILogger.DEBUG))
     ...
     * @see com.reader.office.fc.hssf.record.BoundSheetRecord
     ...
     */
    public Records findNextRecordBySid(short sid, int pos)
    {
        int matches = 0;
        for (Records record : records)
        {
    ...
    */
    ...
    public PaletteRecord getCustomPalette()
    {
        ...
        if (palettePos != -1)
        {
            Records rec = records.get(palettePos);
     ...
     *
     * @see com.reader.office.fc.hssf.usermodel.HSSFWorkbook#setForceFormulaRecalculation(boolean)
     */
