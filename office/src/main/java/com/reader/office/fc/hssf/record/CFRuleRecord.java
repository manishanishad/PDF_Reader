...
import com.reader.office.fc.hssf.formula.Formula;
...
import com.reader.office.fc.hssf.record.cf.BorderFormatting;
import com.reader.office.fc.hssf.record.cf.FontFormatting;
import com.reader.office.fc.hssf.record.cf.PatternFormatting;
import com.reader.office.fc.hssf.usermodel.HSSFSheet;
import com.reader.office.fc.util.BitField;
import com.reader.office.fc.util.BitFieldFactory;
...
/**
 * Conditional Formatting Rule Records (0x01B1).<br/>
 *
...
public final class CFRuleRecord extends StandardRecord {
	...
	private static final BitField font          = bf(0x04000000); // 1 = Records contains font formatting block
	private static final BitField align         = bf(0x08000000); // 1 = Records contains alignment formatting block
	private static final BitField bord          = bf(0x10000000); // 1 = Records contains border formatting block
	private static final BitField patt          = bf(0x20000000); // 1 = Records contains pattern formatting block
	private static final BitField prot          = bf(0x40000000); // 1 = Records contains protection formatting block
