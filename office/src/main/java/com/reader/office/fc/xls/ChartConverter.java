 ...
 * 时间:              下午2:21:40
 */
package com.reader.office.fc.xls;
...
import com.reader.office.fc.hssf.formula.eval.AreaEval;
...
import com.reader.office.fc.hssf.usermodel.HSSFCell;
import com.reader.office.fc.hssf.usermodel.HSSFChart;
import com.reader.office.fc.hssf.usermodel.HSSFDataFormat;
import com.reader.office.fc.hssf.usermodel.HSSFFormulaEvaluator;
import com.reader.office.fc.hssf.usermodel.HSSFName;
import com.reader.office.fc.hssf.usermodel.HSSFChart.HSSFChartType;
import com.reader.office.fc.hssf.usermodel.HSSFChart.HSSFSeries;
import com.reader.office.fc.ss.usermodel.ICell;
import com.reader.office.simpletext.model.SectionElement;
import com.reader.office.ss.model.XLSModel.ACell;
import com.reader.office.ss.model.XLSModel.ARow;
import com.reader.office.ss.model.XLSModel.ASheet;
...
import com.reader.office.thirdpart.achartengine.ChartFactory;
...
import com.reader.office.thirdpart.achartengine.chart.ColumnBarChart.Type;
...
import com.reader.office.thirdpart.achartengine.util.MathHelper;
...
//                else
        ...
        while(iter.hasNext())
        {
            ...
            Records r = chartSeriesText.get(seriesTextRecord);
...
//            
    ...
    private Map<SeriesTextRecord, Records> chartSeriesText;
    double minY, maxY;
}
