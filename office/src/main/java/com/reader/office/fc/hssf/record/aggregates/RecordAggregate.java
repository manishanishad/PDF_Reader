...
/**
 * <tt>RecordAggregate</tt>s are groups of of BIFF <tt>Records</tt>s that are typically stored
...
public abstract class RecordAggregate extends RecordBase {
	 ...
	 * {@link Records}s being used to manage POI's internal implementation.  Callers should not
	 * assume either way, and therefore only attempt to modify those {@link Records}s after cloning
	 */
	...
	public interface RecordVisitor {
		/**
		 * Implementors may call non-mutating methods on Records r.
		 * @param r must not be <code>null</code>
		 */
		void visitRecord(Records r);
	}
