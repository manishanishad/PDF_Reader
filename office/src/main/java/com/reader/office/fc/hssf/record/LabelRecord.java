...
/**
 * Label Records (0x0204) - read only support for strings stored directly in the cell..  Don't
 ...
 */
public final class LabelRecord extends Records implements CellValueRecordInterface {
