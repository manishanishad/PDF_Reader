...
import com.reader.office.fc.hssf.record.aggregates.SharedValueManager;
...
public final class RowBlocksReader {
	...
	public RowBlocksReader(RecordStream rs) {
		List<Records> plainRecords = new ArrayList<Records>();
		List<Records> shFrmRecords = new ArrayList<Records>();
		List<CellReference> firstCellRefs = new ArrayList<CellReference>();
		List<Records> arrayRecords = new ArrayList<Records>();
		List<Records> tableRecords = new ArrayList<Records>();
		List<Records> mergeCellRecords = new ArrayList<Records>();

		Records prevRec = null;
