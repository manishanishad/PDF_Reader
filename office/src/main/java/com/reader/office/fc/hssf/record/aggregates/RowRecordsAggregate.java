...
public final class RowRecordsAggregate extends RecordAggregate {
	...
	private final List<Records> _unknownRecords;
	...
	private RowRecordsAggregate(SharedValueManager svm) {
		...
		_unknownRecords = new ArrayList<Records>();
	 ...
	 */
	private void addUnknownRecord(Records rec) {
	...
	private int visitRowRecordsForBlock(int blockIndex, RecordVisitor rv) {
		...
		while(rowIterator.hasNext() && (i++ < endIndex)) {
		  Records rec = (Records)rowIterator.next();
	 ...
	 * @see com.reader.office.fc.hssf.record.RowRecord
	 */
