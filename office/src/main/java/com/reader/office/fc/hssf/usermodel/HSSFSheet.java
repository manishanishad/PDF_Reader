...
import com.reader.office.fc.hssf.util.Region;
import com.reader.office.fc.ss.SpreadsheetVersion;
import com.reader.office.fc.ss.usermodel.CellRange;
import com.reader.office.fc.ss.usermodel.DataValidation;
import com.reader.office.fc.ss.usermodel.DataValidationHelper;
import com.reader.office.fc.ss.usermodel.ICell;
import com.reader.office.fc.ss.usermodel.ICellStyle;
import com.reader.office.fc.ss.usermodel.IRow;
import com.reader.office.fc.ss.util.CellReference;
import com.reader.office.fc.ss.util.HSSFCellRangeAddress;
import com.reader.office.fc.ss.util.SSCellRange;
import com.reader.office.fc.ss.util.SheetUtil;
 ...
 */
public final class HSSFSheet implements com.reader.office.fc.ss.usermodel.Sheet
{
     ...
     * @see com.reader.office.fc.hssf.usermodel.HSSFWorkbook#createSheet()
     */
    ...
    private void setPropertiesFromSheet(InternalSheet sheet)
    {
        ...
        while (iter.hasNext())
        {
            ...
            if (log.check(POILogger.DEBUG))
                log.log(DEBUG, "record id = " + Integer.toHexString(((Records)cval).getSid()));
     ...
     * @see com.reader.office.fc.hssf.usermodel.HSSFRow
     * @see #removeRow(com.com.reader.office.fc.ss.usermodel.IRow)
     */
   ...
   public void setColumnPixelWidth(int columnIndex, int width)
   {
     ...
     */
    public int addMergedRegion(com.reader.office.fc.ss.util.Region region)
    {
     ...
     *
     *  <p>
     *  Calculating the formula values with {@link com.reader.office.fc.ss.usermodel.com.reader.office.fc.ss.usermodel.FormulaEvaluator} is the
     ...
     *  {@link com.reader.office.ss.model.baseModel.com.reader.office.fc.ss.usermodel.Workbook#setForceFormulaRecalculation(boolean)}
     ...
     *
     * @see com.reader.office.ss.model.baseModel.com.reader.office.fc.ss.usermodel.Workbook#setForceFormulaRecalculation(boolean)
     */
    ...
    protected void insertChartRecords(List<Records> records)
    {
