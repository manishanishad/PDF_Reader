...
import com.reader.office.fc.hssf.record.chart.SeriesChartGroupIndexRecord;
...
/**
 * Title:  Records Factory<P>
 * Description:  Takes a stream and outputs an array of Records objects.<P>
 *
 * @see com.reader.office.fc.hssf.eventmodel.EventRecordFactory
...
public final class RecordFactory
{
    ...
    {
        Records create(RecordInputStream in);

        Class< ? extends Records> getRecordClass();
    }

    private static final class ReflectionConstructorRecordCreator implements I_RecordCreator
    {

        private final Constructor< ? extends Records> _c;

        public ReflectionConstructorRecordCreator(Constructor< ? extends Records> c)
        {
            _c = c;
        }

        public Records create(RecordInputStream in)
        {
            Object[] args = {in,};
            try
            {
        ...
        public Class< ? extends Records> getRecordClass()
        {
    ...
    private static final class ReflectionMethodRecordCreator implements I_RecordCreator
    {
        ...
        public Records create(RecordInputStream in)
        {
            ...
            try
            {
                return (Records)_m.invoke(null, args);
            }
            catch(IllegalArgumentException e)
            {
                throw new RuntimeException(e);
        ...
        public Class< ? extends Records> getRecordClass()
        {
            return (Class< ? extends Records>)_m.getDeclaringClass();
        }
    }
     ...
     * Note - this most but not *every* subclass of Records.
     */
    @ SuppressWarnings("unchecked")
    private static final Class< ? extends Records>[] recordClasses = new Class[]{ArrayRecord.class,
     ...
     */
    public static Class< ? extends Records> getRecordClass(int sid)
    {
     ...
     */
    public static Records[] createRecord(RecordInputStream in)
    {

        Records record = createSingleRecord(in);
        ...
        {
            return new Records[]{convertToNumberRecord((RKRecord)record),};
        }
    ...
    public static Records createSingleRecord(RecordInputStream in)
    {
     ...
     * @return map of SIDs to short,short,byte[] constructors for Records classes
     * most of org.apache.poi.hssf.record.*
     */
    private static Map<Integer, I_RecordCreator> recordsToMap(Class< ? extends Records>[] records)
    {
        ...
        for (int i = 0; i < records.length; i++)
        {
            ...
            Class< ? extends Records> recClass = records[i];
            if (!Records.class.isAssignableFrom(recClass))
            {
    ...
    private static I_RecordCreator getRecordCreator(Class< ? extends Records> recClass)
    {
        try
        {
            Constructor< ? extends Records> constructor;
     ...
     */
    public static List<Records> createRecords(InputStream in) throws RecordFormatException
    {
     ...
     * @exception RecordFormatException on error processing the InputStream
     */
    public static List<Records> createRecords(InputStream in, AbstractReader iAbortListener) throws RecordFormatException
    {

        List<Records> records = new ArrayList<Records>(NUM_RECORDS);
