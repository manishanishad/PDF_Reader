...
public final class RecordTypes {
    ...
    public static HashMap<Integer,Class<? extends Records>> typeToClass;
...
//    public static final Type BinaryTagData = new Type(5003,DummyPositionSensitiveRecordWithChildren.class);
     ...
     */
	public static Class<? extends Records> recordHandlingClass(int type) {
		Class<? extends Records> c = typeToClass.get(Integer.valueOf(type));
		return c;
	}

    static {
		typeToName = new HashMap<Integer,String>();
		typeToClass = new HashMap<Integer,Class<? extends Records>>();
        try {
            ...
            for (int i = 0; i < f.length; i++){
               ...
               if (val instanceof Type) {
                  Type t = (Type)val;
                  Class<? extends Records> c = t.handlingClass;
	...
	public static class Type {
		public int typeID;
		public Class<? extends Records> handlingClass;
		public Type(int typeID, Class<? extends Records> handlingClass) {
			this.typeID = typeID;
