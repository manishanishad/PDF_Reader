...
public abstract class TextShape extends SimpleShape
{
    ...
    /**
     * Create a TextBox object and initialize it from the supplied Records container.
     *
    ...
    public TextRun createTextRun()
    {
        ...
        if (_txtrun == null)
        {
            ...
            _txtrun._records = new Records[]{tha, tca, sta};
            _txtrun.setText("");
    ...
    public byte getMetaCharactersType()
    {
        ...
        {
            Records[] children = clientTextBox.getChildRecords();
    ...
    */
    ...
    protected void initTextRun()
    {
        ...
        Records[] child = txtbox.getChildRecords();
        ...
        if (_txtrun != null)
            for (int i = 0; i < child.length; i++)
            {
                ...
                /*for (Records r : _txtrun.getRecords())
                {
     ...
     * @see com.reader.office.fc.hslf.usermodel.SlideShow#addHyperlink(Hyperlink)
     */
