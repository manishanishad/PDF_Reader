...
import com.reader.office.fc.hssf.record.Margin;
...
public final class PageSettingsBlock extends RecordAggregate {
     ...
     *  see {@link  com.reader.office.fc.hssf.record.HeaderFooterRecord#getGuid()}
     */
    private List<HeaderFooterRecord> _sviewHeaderFooters = new ArrayList<HeaderFooterRecord>();
    private Records _printSize;
	...
	/**
	 * @return <code>true</code> if the specified Records sid is one belonging to the
	 * 'Page Settings Block'.
	 */
	...
	private void checkNotPresent(Records rec) {
		if (rec != null) {
	...
	private static void visitIfPresent(Records r, RecordVisitor rv) {
		if (r != null) {
			rv.visitRecord(r);
		}
	}
	...
	/**
	 * creates the HCenter Records and sets it to false (don't horizontally center)
	 */
	...
	/**
	 * creates the VCenter Records and sets it to false (don't horizontally center)
	*/
	...
	/**
	 * creates the PrintSetup Records and sets it to defaults and marks it invalid
	 * @see com.reader.office.fc.hssf.record.PrintSetupRecord
