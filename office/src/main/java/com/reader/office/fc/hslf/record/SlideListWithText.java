...
public final class SlideListWithText extends RecordContainer {
    ...
    protected SlideListWithText(byte[] source, int start, int len) {
        ...
        // Find our children
        _children = Records.findChildRecords(source, start + 8, len - 8);
        ...
        for (int i = 0; i < _children.length; i++) {
            if (_children[i] instanceof SlidePersistAtom) {
                ...
                Records[] spaChildren = new Records[clen];
    ...
    public void addSlidePersistAtom(SlidePersistAtom spa) {
        ...
        SlideAtomsSet newSAS = new SlideAtomsSet(spa, new Records[0]);
    ...
    public class SlideAtomsSet {
         ...
         */
        public Records[] getSlideRecords() {
            return slideRecords;
        }
         ...
         */
        public SlideAtomsSet(SlidePersistAtom s, Records[] r) {
            slidePersistAtom = s;
            slideRecords = r;
        }
