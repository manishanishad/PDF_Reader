...
public final class ShapeFactory
{
    ...
    protected static Records getClientDataRecord(EscherContainerRecord spContainer, int recordType)
    {
        Records oep = null;
        for (Iterator<EscherRecord> it = spContainer.getChildIterator(); it.hasNext();)
        {
            ...
            if (obj.getRecordId() == EscherClientDataRecord.RECORD_ID)
            {
                ...
                Records[] records = Records.findChildRecords(data, 8, data.length - 8);
