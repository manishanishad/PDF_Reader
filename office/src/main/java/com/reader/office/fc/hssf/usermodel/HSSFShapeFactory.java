...
import com.reader.office.fc.ddf.EscherPropertyFactory;
...
{    
    public static HSSFShape createShape(AWorkbook workbook, Map<EscherRecord, Records> shapeToObj, 
    ...
    public static HSSFShapeGroup createShapeGroup(AWorkbook workbook, Map<EscherRecord, Records> shapeToObj, 
                  EscherContainerRecord spContainer, HSSFShape parent)
    {
    ...
    public static HSSFShape createSimpeShape(AWorkbook workbook, Map<EscherRecord, Records> shapeToObj, 
                  EscherContainerRecord spContainer, HSSFShape parent)
    {
        ...
        switch (type)
        {
            case ShapeTypes.TextBox:
                if (shapeToObj != null && shapeToObj.size() > 0)
                {
                    ...
                    Records record = shapeToObj.get(escherClientDataRecord);                 
...
//     */
//    public static void createShapeTree(EscherContainerRecord container, Map<EscherRecord, Records> shapeToObj, HSSFShapeContainer out, DirectoryNode root)
//    {
