 ...
 * instances of HSSFListener with each Records.sid you wish to listen for.
 *
 * @see com.reader.office.fc.hssf.eventusermodel.HSSFEventFactory
 * @see com.reader.office.fc.hssf.eventusermodel.HSSFListener
 * @see com.reader.office.fc.hssf.eventusermodel.HSSFUserException
...
public class HSSFRequest {
	...
	/**
	 * Called by HSSFEventFactory, passes the Records to each listener associated with
	 * a record.sid.
	 *
	 ...
	 */
	protected short processRecord(Records rec) throws HSSFUserException {
