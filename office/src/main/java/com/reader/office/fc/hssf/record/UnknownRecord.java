...
/**
 * Title:        Unknown Records (for debugging)<p/>
...
public final class UnknownRecord extends StandardRecord {
	...
	/*
	 * Some Records IDs used by POI as 'milestones' in the record stream
	 */
	/**
	...
	/**
	 * Environment-Specific Print Records
	 */
	...
	public static String getBiffName(int sid) {
		...
		// this method any time a new Records subclass is created.
		switch (sid) {
