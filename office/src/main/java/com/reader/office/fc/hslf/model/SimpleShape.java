...
{
    /**
     * Create a SimpleShape object and initialize it from the supplied Records container.
     *
...
//            double height = anchor.getHeight() / scale;
     ...
     */
    protected Records getClientDataRecord(int recordType)
    {
        Records[] records = getClientRecords();
        if (records != null)
        {
     ...
     */
    protected Records[] getClientRecords()
    {
        if (_clientData == null)
        {
        ...
        if (_clientData != null && _clientRecords == null)
        {
            ...
            _clientRecords = Records.findChildRecords(data, 0, data.length);
        }
    ...
    public void dispose()
    {
       ...
       {
           for (Records rec : _clientRecords)
           {
               rec.dispose();
           }
           _clientRecords = null;
     ...
     */
    protected Records[] _clientRecords;
