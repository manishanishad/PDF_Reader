...
import com.reader.office.fc.POIDocument;
import com.reader.office.fc.codec.DigestUtils;
...
import com.reader.office.fc.hssf.formula.FormulaShifter;
import com.reader.office.fc.hssf.formula.FormulaType;
import com.reader.office.fc.hssf.formula.SheetNameFormatter;
import com.reader.office.fc.hssf.formula.ptg.Area3DPtg;
import com.reader.office.fc.hssf.formula.ptg.MemFuncPtg;
import com.reader.office.fc.hssf.formula.ptg.Ptg;
import com.reader.office.fc.hssf.formula.ptg.UnionPtg;
import com.reader.office.fc.hssf.formula.udf.AggregatingUDFFinder;
import com.reader.office.fc.hssf.formula.udf.UDFFinder;
import com.reader.office.fc.hssf.model.DrawingManager2;
import com.reader.office.fc.hssf.model.HSSFFormulaParser;
import com.reader.office.fc.hssf.model.InternalSheet;
import com.reader.office.fc.hssf.model.InternalWorkbook;
import com.reader.office.fc.hssf.model.RecordStream;
...
import com.reader.office.fc.hssf.record.EmbeddedObjectRefSubRecord;
...
import com.reader.office.fc.hssf.record.RecordBase;
import com.reader.office.fc.hssf.record.RecordFactory;
import com.reader.office.fc.hssf.record.SSTRecord;
import com.reader.office.fc.hssf.record.SubRecord;
import com.reader.office.fc.hssf.record.UnknownRecord;
import com.reader.office.fc.hssf.record.aggregates.RecordAggregate.RecordVisitor;
import com.reader.office.fc.hssf.record.common.UnicodeString;
import com.reader.office.fc.hssf.util.CellReference;
import com.reader.office.fc.poifs.filesystem.DirectoryNode;
import com.reader.office.fc.poifs.filesystem.POIFSFileSystem;
import com.reader.office.fc.ss.usermodel.IRow.MissingCellPolicy;
import com.reader.office.fc.ss.util.WorkbookUtil;
 ...
 *
 * @see com.reader.office.fc.hssf.model.InternalWorkbook
 * @see com.reader.office.fc.hssf.usermodel.HSSFSheet
 * @author  Andrew C. Oliver (acoliver at apache dot org)
 * @author  Glen Stampoultzis (glens at apache.org)
 * @author  Shawn Laubach (slaubach at apache dot org)
 */
public final class HSSFWorkbook extends POIDocument implements com.reader.office.fc.ss.usermodel.Workbook
{
     ...
     *        in memory
     * @see com.reader.office.fc.poifs.filesystem.POIFSFileSystem
    ...
    public HSSFWorkbook(DirectoryNode directory, boolean preserveNodes) throws IOException
    {
        ...
        List<Records> records = RecordFactory.createRecords(stream);
...
//            names.add(name);
    ...
    /**
      ...
      * @see com.reader.office.fc.hssf.record.LabelRecord
      * @see com.reader.office.fc.hssf.record.LabelSSTRecord
      * @see com.reader.office.fc.hssf.record.SSTRecord
      */
    ...
    private void convertLabelRecords(List records, int offset)
    {
        ...
        {
            Records rec = (Records)records.get(k);
     ...
     * @see com.reader.office.fc.hssf.usermodel.HSSFSheet#setSelected(boolean)
     */
     ...
     * @see {@link com.reader.office.fc.ss.util.WorkbookUtil#createSafeSheetName(String nameProposal)}
     ...
     */
    public int getSheetIndex(com.reader.office.fc.ss.usermodel.Sheet sheet)
    {
...
//            names.add(newName);
    ...
    private static final class SheetRecordCollector implements RecordVisitor
    {
        ...
        public void visitRecord(Records r)
        {
            _list.add(r);
        ...
        public int serialize(int offset, byte[] data)
        {
            ...
            {
                Records rec = (Records)_list.get(i);
...
//        return newName;
     ...
     * @see com.reader.office.fc.hssf.record.FormatRecord
     * @see com.reader.office.fc.hssf.record.Records
     */
    ...
    public List<HSSFPictureData> getAllPictures()
    {
        ...
        Iterator<Records> recordIter = workbook.getRecords().iterator();
        while (recordIter.hasNext())
        {
            Records r = recordIter.next();
