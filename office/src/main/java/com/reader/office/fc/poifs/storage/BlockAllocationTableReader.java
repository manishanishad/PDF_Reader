...
package com.reader.office.fc.poifs.storage;

import java.io.IOException;
import java.util.ArrayList;
import java.util.List;

import com.reader.office.fc.poifs.common.POIFSBigBlockSize;
import com.reader.office.fc.poifs.common.POIFSConstants;
import com.reader.office.fc.util.IntList;
...
public final class BlockAllocationTableReader {
    ...
    public BlockAllocationTableReader(POIFSBigBlockSize bigBlockSize, int block_count, int [] block_array,
        ...
        for (block_index = 0; block_index < limit; block_index++)
        {
            ...
            // Records the sector number of this BAT block 
            blocks[ block_index ] =
