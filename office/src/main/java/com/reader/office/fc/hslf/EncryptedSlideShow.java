...
public final class EncryptedSlideShow
{
    ...
    {
        // Will be the last Records pointed to by the
        ...
        if (cua.getCurrentEditOffset() != 0)
        {
            ...
            try
            {
                r = Records.buildRecordAtOffset(hss.getUnderlyingBytes(),
            ...
            Records r2 = Records.buildRecordAtOffset(hss.getUnderlyingBytes(),
            ...
            int offset = ((Integer)pph.getSlideLocationsLookup().get(Integer.valueOf(maxSlideId)))
                .intValue();
            Records r3 = Records.buildRecordAtOffset(hss.getUnderlyingBytes(), offset);
