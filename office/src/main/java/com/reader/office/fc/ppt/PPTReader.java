...
{   
    ...
    private void processSlideshow(PGSlide pgSlide, SlideProgTagsContainer propTagsContainer)
    {
        try
        {
            ...
            Records[] records = propTagsContainer.getChildRecords();
            ...
            Records rec = ((SlideProgBinaryTagContainer)records[0]).findFirstOfType(BinaryTagDataBlob.RECORD_ID);
            if(rec == null)
            {
                return;
            }
    ...
    private List<ShapeAnimation> processAnimation(PGSlide pgSlide, TimeNodeContainer timeNodeContainer)
    {
        try
        {
            ...
            Records[] childRecords = timeNodeContainer.getChildRecords();
            ...
            if(timeNodeContainerList.size() > 1)
            {
                ...
                {
                    Records record = container.findFirstOfType(TimeNodeContainer.RECORD_ID);
                    if(record != null)
                    {
    ...
    private ShapeAnimation processSingleAnimation(PGSlide pgSlide, TimeNodeContainer timeNodeContainer)
    {
        try
        {
          //animation type
            ...
            Records[] records = timeNodeAttrContainer.getChildRecords();
            for(Records record : records)
            {
