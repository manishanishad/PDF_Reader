...
import com.reader.office.fc.hssf.formula.ptg.ExpPtg;
...
import com.reader.office.fc.hssf.record.CommonObjectDataSubRecord;
...
import com.reader.office.fc.ss.usermodel.Comment;
...
import com.reader.office.fc.ss.usermodel.IHyperlink;
import com.reader.office.fc.ss.usermodel.RichTextString;
import com.reader.office.fc.ss.util.CellReference;
import com.reader.office.fc.ss.util.HSSFCellRangeAddress;
import com.reader.office.fc.ss.util.NumberToTextConverter;
...
public class HSSFCell implements ICell {
     ...
     *
     * @see com.reader.office.fc.hssf.usermodel.HSSFRow#createCell(short)
     */
     ...
     *                Type of cell
     * @see com.reader.office.fc.hssf.usermodel.HSSFRow#createCell(short,int)
     */
    protected HSSFCell(HSSFWorkbook book, HSSFSheet sheet, int row, short col,
                       int type)
    {
        checkBounds(col);
        _cellType     = -1; // Force 'setCellType' to create a first Records
        _stringValue  = null;
        _book    = book;
        _sheet   = sheet;
     ...
     * @param book - Workbook record of the workbook containing this cell
     * @param sheet - Sheet record of the sheet containing this cell
     * @param cval - the Cell Value Records we wish to represent
     */
...
//        agg.setParsedExpression(ptgs);
     ...
     * @see com.reader.office.fc.hssf.usermodel.HSSFWorkbook#createCellStyle()
     * @see com.reader.office.fc.hssf.usermodel.HSSFWorkbook#getCellStyleAt(short)
     */
     ...
     * @see HSSFRow#removeCell(com.com.reader.office.fc.ss.usermodel.ICell)
     * @see com.reader.office.fc.hssf.usermodel.HSSFSheet#removeRow(org.apache.poi.ss.usermodel.Row)
     * @see com.reader.office.fc.hssf.usermodel.HSSFSheet#shiftRows(int, int, int)
     * @see com.reader.office.fc.hssf.usermodel.HSSFSheet#addMergedRegion(com.reader.office.fc.ss.util.HSSFCellRangeAddress)
